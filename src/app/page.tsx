...
export default function Home() {
  ...
  return (
    <div className=" min-h-screen w-screen flex flex-col items-center [&_*]:fill-white">
      ...
      <section className="self-start">
        <div className=" min-h-96 min-w-96  mt-[700px] ml-20">
          <ul className=" flex-row text-right space-y-10 justify-between items- size-full m-5 ">
        ...
        <div className=" bg-red-500 size-7"></div>
      </section>
    </div>
  );
}
